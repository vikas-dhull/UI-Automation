...
public class MB_OrderSuccessPage extends CommonFunctions
{

	public WebDriver driver;
	public GenericDbActions dbActions;
	
	public MB_OrderSuccessPage(WebDriver driver) 
	{
		this.driver = driver;
	...
	@FindBy(xpath="//div[contains(@class,'successfull-box hidden-xs')]//p[contains(text(),'Your Order HKD')]")
