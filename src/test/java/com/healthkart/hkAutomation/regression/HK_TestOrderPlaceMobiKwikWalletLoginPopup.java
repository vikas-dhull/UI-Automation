...
public class HK_TestOrderPlaceMobiKwikWalletLoginPopup extends ExtentReportingBaseUtil{
	
	private String gatewayOrderId=null;
	private int cartCount;
	
	/**
	 * Test Order Place with MobiKwik wallet.
	 */
	@Test(priority = 1)
	public void testOrderPlaceMobiKwikWalletLoginPopup() {	
		System.out.println("ORDER PLACE PREPAID WITH MOBIKWIK WALLET Test starts..");
		test.log(LogStatus.INFO, "ORDER PLACE PREPAID WITH MOBIKWIK WALLET Test starts..");
		/*
		...
		pymntB.performWalletPaymentMobiKwik();
	 ...
	 */
	@Test(dependsOnMethods=( "testOrderPlaceMobiKwikWalletLoginPopup"))
	public void cancelPrepaidCCOrder() {
		System.out.println("## CANCEL PREPAID ORDER (MOBIKWIK WALLET) Test starts..");
		test.log(LogStatus.INFO, "CANCEL PREPAID ORDER (MOBIKWIK WALLET) Test starts..");
