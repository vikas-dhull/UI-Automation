...
public class Omni_Channel_Order_COD_Checkout_DeliveryBySM extends ExtentReportingBaseUtil
{	
	private String gatewayOrderId=null;
	private long customerOrderId;
	
	@Test(priority=1,enabled=true)
	public void testCODOrderPlaceHKDeliveryBySM() {
		comnFunc.reportLogAndPrintInConsole("## HK OMNI CHANNEL ORDER PLACE COD, DELEVERED BY STORE MANAGER..");
		...
		Assert.assertTrue(omniChnlOrdrSteps.acceptOrderAndMarkForDeliverBySM(), "Failed to mark order status as Deliver By SM..!!");
		comnFunc.reportLogAndPrintInConsole("order status found as Deliver By SM");
