...
public class POS_Test_Place_Order_Freebie_Counter_Cash extends ExtentReportingBaseUtil
{
	private String gatewayOrderId=null;
	
	@Test(priority=1,enabled=true)
	public void testOrderPlaceWithFreebiePOSCash() {
		comnFunc.reportLogAndPrintInConsole("## POS ORDER PLACE TEST APPLYING FREEBIE STARTS..");
		...
		Assert.assertTrue(posSteps.posAddAndVerifyFreebie(), "NOT able to apply Freebie on POS order..!!");
		comnFunc.reportLogAndPrintInConsole("Freebie applied successfully for POS order..");
