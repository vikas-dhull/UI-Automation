...
public class Omni_Channel_Order_Prepaid_Accepted_StorePickUp extends ExtentReportingBaseUtil
{
	private String gatewayOrderId=null;
	private long customerOrderId;
	
	@Test(priority=1,enabled=true)
	public void testPrepaidOrderPlacePOSAcceptedCheckout() {
		comnFunc.reportLogAndPrintInConsole("## HK OMNI CHANNEL ORDER PLACE PREPAID, ACCEPTED AS STORE PICKUP, CHECKOUT AT STORE..");
		...
		Assert.assertTrue(posSteps.verifyPOSScreenElements("PREPAID"), "POS screen elements not verified..!!");
		...
		Assert.assertTrue(posSteps.performPayments("Prepaid"),"Payment was not successfull..!!");
