...
public class POS_Test_Place_Order_Coupon_Offer_Counter_Cash extends ExtentReportingBaseUtil
{
	private String gatewayOrderId=null;
	
	@Test(priority=1,enabled=true)
	public void testOrderPlacePOSCouponOfferCash() {
		comnFunc.reportLogAndPrintInConsole("## POS ORDER PLACE TEST APPLYING COUPON OFFER STARTS..");
