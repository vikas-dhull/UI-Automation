...
public class HK_Test_Wishlist_AndroidMsite extends ExtentReportingBaseUtil
{
	...
	{	
		System.out.println("## Test Wishlist from PDP page..");
		test.log(LogStatus.INFO, "## Test Wishlist from PDP page..");
		/*
