...
public class HK_Test_Order_Place_Partial_HKCash_COD_Login_Popup_AndroidMsite extends ExtentReportingBaseUtil
{
	...
	{	
		System.out.println("## ORDER PLACE COD PARTIAL HK-CASH WITH LOGIN POPUP Test starts..");
		test.log(LogStatus.INFO, "ORDER PLACE COD PARTIAL HK-CASH WITH LOGIN POPUP Test starts..");
		/*
		...
		WebDriverUtil.addHKCashForUser(testdata.get("Login_User_Mobile_Msite"), "partial",1);
		...
		Assert.assertTrue(WebDriverUtil.verifyHKCashPresentForUser(testdata.get("Login_User_Mobile_Msite"), "partial",1),"Sufficient HKCASH not present for this user cart..");
