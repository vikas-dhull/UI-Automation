...
public class HK_Test_Order_Place_Prompt_COD_Login_Popup_AndroidMsite extends ExtentReportingBaseUtil
{
	...
	{	
		...
		loginStep.performLoginWithMobilePassword(testdata.get("Login_User_Mobile_Msite"), testdata.get("Login_User_Mobile_Password_Msite"));
		...
		Assert.assertTrue(cartStep.applyPromptOfferAndVerify(), "Fail to Apply Prompt Offer on Cart page..");
