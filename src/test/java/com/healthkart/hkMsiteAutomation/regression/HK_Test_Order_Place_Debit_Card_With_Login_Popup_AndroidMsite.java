...
public class HK_Test_Order_Place_Debit_Card_With_Login_Popup_AndroidMsite extends ExtentReportingBaseUtil
{
	private int cartCount;
	private String gatewayOrderId=null;
	
	@Test(priority=1,enabled=true)
	public void testOrderPlaceDebitCardWithLoginPopup()
	{	
	...
	@Test(dependsOnMethods=( "testOrderPlaceDebitCardWithLoginPopup"))
